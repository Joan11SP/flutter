...
import 'package:nannys/src/services/validate.dart';
...
class _UsersView extends State<Users> {
  ...
  var body = jsonEncode(<String, dynamic>{
    'cedula': _person.dni,
    'name': _person.name,
    'last_name': _person.lastName,
    'fecha_nacimiento': _person.dateBirth,
    'telefono': _person.phone,
    'email': _person.email,
    'city': _person.city
  });
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            /*new ListTile(
              title: new Icon(Icons.calendar_today),
              onTap: () {
                showDatePicker(
                        context: context,
            ...
            new ListTile(
              title: DateTimeField(
                ...
                onChanged: (value)=>_person.dateBirth= value.toString(),
              ),
            ),
            new ListTile(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      ...
                      formState.save();
                      print('AAAASDASDASDASDASDASDASDASDASDASD');
                      print(_person.user());
                    }
                  },
                  child: Text('Aceptar'),
